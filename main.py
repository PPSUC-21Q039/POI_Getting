...
def get_poi(processeed_position, result_types):
    url = 'https://restapi.amap.com/v5/place/polygon?' + 'key=aad49afa17b46e85e060bbe252f25a80' + '&polygon=' + str(processeed_position).strip() + '&types=' + str(result_types).strip()
...
if __name__ == "__main__":
    ...
    for police_station_key, value in json_data.items(): # police_station_key 为该派出所的名称，vlaue 为其后的所有键值对
        ...
        for hexagon_id_key in value:
            ...
            print ('ID:', hexagon_id_key, ', 坐标:', center_position_longtitude, ',', center_position_latitude)
